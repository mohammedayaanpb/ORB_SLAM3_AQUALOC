...
SEQUENCE_DIR=$BASE_DIR/Preprocessed/FUnIE_GAN/Harbor/sequence_01
CONFIG=$BASE_DIR/Configs/harbor_funie.yaml
RESULTS_DIR=$BASE_DIR/Results/FUnIE_GAN/Harbor_seq01
ASSOCIATIONS=$SEQUENCE_DIR/associations.txt

echo "=========================================="
echo "Running ORB-SLAM3 on FUnIE-GAN Enhanced Images"
echo "Config: $CONFIG"
echo "=========================================="
